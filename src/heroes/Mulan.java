...
public class Mulan extends AbstractHero {
  ...
  public Mulan(HeroParameters parameters) {
    super(parameters.level, HERO_CLASS,FACTION,
      interpolateStatsLinearly(baseHP,parameters.level),
      interpolateStatsLinearly(baseAttack,parameters.level),
      interpolateStatsLinearly(baseArmor,parameters.level),
      interpolateStatsLinearly(baseSpeed,parameters.level),
      parameters.loadout);
  }
}
