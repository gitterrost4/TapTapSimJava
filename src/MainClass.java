...
public class MainClass {
  ...
  public static void main(String[] args) {
    AbstractHero heroA1 = new Rlyeh(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.STARSHARDS)));
    AbstractHero heroA2 = new Rlyeh(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroA3 = new Rlyeh(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroA4 = new Rlyeh(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.RED2, RuneType.SPEED, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroA5 = new Rlyeh(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroA6 = new Rlyeh(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
    ...
    AbstractHero heroD1 = new Reaper(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.STARSHARDS)));
    AbstractHero heroD2 = new Reaper(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroD3 = new Reaper(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroD4 = new Reaper(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroD5 = new Reaper(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.RED2, RuneType.SPEED, ArtifactType.EYEOFHEAVEN)));
    AbstractHero heroD6 = new Reaper(new HeroParameters(244, 10,
        new Loadout(EquipmentRarity.ORANGE2, RuneRarity.ORANGE2, RuneType.VITALITY, ArtifactType.EYEOFHEAVEN)));
