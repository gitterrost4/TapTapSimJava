...
public class Familiars {
  ...
  public enum FamiliarType {
    ...
    /** a human-readable name of the corresponding familiar */
     ...
     * 
     * @param name
     *        human-readable name of the familiar
     */
    ...
    /**
     * @return the human-readable name of the familiar
     */
  ...
  public static abstract class AbstractFamiliar {
    ...
    /**
     * a map specifying the number of targets (_0) and the damage done (_1) by the
     * active pet skill for each skill level
     */
    ...
    /**
     * tri-state containing whether this is on the attacking team or the defending team
     * or unknown
     */
    protected Optional<Boolean> isAttacker = Optional.empty();

    /** the name (type) of the familiar */
    private final FamiliarType name;

    /** the current energy (0-100) of the familiar */
    ...
    public LogItem activeAttack(BattleSetting setting) {
      Log log = new Log();
      Integer targetCount = skillDamageAndTargetPerSkillLevel.get(levelSkill1)._0;
      Integer damage = skillDamageAndTargetPerSkillLevel.get(levelSkill1)._1;
    ...
    /**
     * log a message with information about the familiar
     * 
     * @param message
     *        message to be included
     * @return a log message object containing the amended message
     */
    ...
    /**
     * put this familiar on the attacking team
     */
    ...
    /**
     * put this familiar on the defending team
     */
    ...
    /**
     * @return the energy of the familiar
     */
    ...
    /**
     * add a set amount of energy to the familiar
     * 
     * @param amount
     *        amount of energy to add
     * @return the log item containing information about this operation
     */
    public LogItem addEnergy(double amount) {
      Log log = new Log();
      energy = Math.min(100, energy + amount);
      log.addItem(logMessage("Adding " + amount + " of energy"));
      return log;
    }
